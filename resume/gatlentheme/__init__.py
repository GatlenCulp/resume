...
class Header(o.Header):
    ...
    separator_between_connections: str = o.header_separator_between_connections_field_info
...
class SectionTitles(o.SectionTitles):
    ...
    vertical_space_above: o.TypstDimension = o.section_titles_vertical_space_above_field_info
    vertical_space_below: o.TypstDimension = o.section_titles_vertical_space_below_field_info
...
class EducationEntry(o.EducationEntry):
    ...
    degree_column_template: Optional[str] = o.education_entry_degree_column_template_field_info
    date_and_location_column_template: str = (
        o.entry_base_with_date_date_and_location_column_template_field_info
    )


o.normal_entry_main_column_first_row_template_field_info.default = "**NAME** -- **LOCATION**"


class NormalEntry(o.NormalEntry):
    main_column_first_row_template: str = o.normal_entry_main_column_first_row_template_field_info
    date_and_location_column_template: str = (
        o.entry_base_with_date_date_and_location_column_template_field_info
    )
...
class GatlenthemeThemeOptions(o.ThemeOptions):
    theme: Literal["gatlentheme"] = o.theme_options_theme_field_info
